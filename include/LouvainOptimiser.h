#ifndef LEIDEN_CCD_LOUVAINOPTIMISER_H
#define LEIDEN_CCD_LOUVAINOPTIMISER_H
...
template <class T> T* LouvainOptimiser::find_partition(Graph* graph)
{
...
template <class T> T* LouvainOptimiser::find_partition(Graph* graph, double resolution_parameter)
{
...
#endif //LEIDEN_CCD_LOUVAINOPTIMISER_H
